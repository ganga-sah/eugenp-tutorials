...
import com.baeldung.cassandra.java.client.domain.ItemAttribute;
...
public class ItemAttributeRepository {
    ...
    private static final String TABLE_NAME = "item_attribute";

    private static final String TABLE_NAME_BY_TITLE = TABLE_NAME + "ByTitle";

    private Session session;

    public ItemAttributeRepository(Session session) {
     ...
     * @return
     */
    public List<ItemAttribute> selectAll() {
        ...
        for (Row r : rs) {
            ItemAttribute itemAttribute = new ItemAttribute(r.getUUID("item_id"), r.getString("field_id"), r.getString("attachment_id"), r.getString("channel_id"), r.getString("ext_id"), r.getString("value"));
